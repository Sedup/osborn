    ...
    <div class="container">
        ...
        <div class="broomate-description">
            ...
            <div class="broomate-description__block">
                ...
                <div class="broomate-description__block--slider"> 
                    <div class="swiper-container swiper-broomate">
                        <!-- Additional required wrapper -->
                        <div class="swiper-wrapper">
                        <!-- Slides -->
                        <div class="swiper-slide">
                            <img src="/img/products/Broomate/Broomate_1.jpg" alt="Brush Broomate" class="slider-imag">
                        </div>
                        <div class="swiper-slide">
                            <img src="/img/products/Broomate/Broomate_2.jpg" alt="Brush Broomate" class="slider-imag">
                        </div>
                        <div class="swiper-slide">
                            <img src="/img/products/Broomate/Broomate_3.jpg" alt="Brush Broomate" class="slider-imag">
                        </div>
                        <div class="swiper-slide">
                            <img src="/img/products/Broomate/Broomate_4.jpg" alt="Brush Broomate" class="slider-imag">
                        </div>
                        </div>
                        <!-- Navigation -->
